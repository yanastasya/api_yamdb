Груповой проект в рамках учебного курса Backend Python-разработчик от Яндекс.Практикум. Создание API по технической документации на Python в фреймфорке Django, командная работа с GitHub.
